...
*                            of the stack.
*
*              exit          is a pointer to function will be called when task return.
*
...
OS_STK *OSTaskStkInit(void *task, void *parg, OS_STK *ptos, void *exit)
{
    OS_STK *stk;
    ...
    *(--stk)  = (uint32_t)exit;                     /* R14 (LR) (init value will cause fault if ever used)*/
    *(--stk)  = (uint32_t)0x12121212u;             /* R12                                                */
    *(--stk)  = (uint32_t)0x03030303u;             /* R3                                                 */
    *(--stk)  = (uint32_t)0x02020202u;             /* R2                                                 */
    *(--stk)  = (uint32_t)0x01010101u;             /* R1                                                 */
    *(--stk)  = (uint32_t)parg;                   /* R0 : argument                                      */
